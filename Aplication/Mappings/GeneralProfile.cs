...
namespace Application.Mappings
{
    public class GeneralProfile : Profile
    {
        public GeneralProfile()
        {
            ...
            CreateMap<Servicio, ServicioResponse>().ReverseMap();

            //TIPO DE DOLAR
            CreateMap<TipoDolar, TipoDolarRequest>().ReverseMap();
            CreateMap<TipoDolar, TipoDolarResponse>().ReverseMap();
            ...
            //CUOTA SERVICIO
            CreateMap<CuotaServicio, CuotaServicioRequest>().ReverseMap();
